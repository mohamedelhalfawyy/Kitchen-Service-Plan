# Manzilik Coding Challenge

A Kitchen Service Plan created with Python & Django & MYSQL


# Setup

This project uses Django and Django REST Framework. To get started, you will need to:
...
#### In settings.py, change the database credentials to your local database credentials.
...
```bash
# To get service plans for a specific date
http://127.0.0.1:8000/service-plan/2023/06/11/

# To add a new employee
http://127.0.0.1:8000/employee/add/

# To Remove an employee
http://127.0.0.1:8000/remove/id
```
...
- 🔭 I’m currently working on [Zoe Website](https://github.com/mohamedelhalfawyy/Zoe_Frontend)
